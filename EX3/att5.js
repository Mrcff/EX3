...
function melhorAluno(escola) {
    let melhorMedia = 0;
    let melhorAluno = "";

    for (let ano in escola) {
        escola[ano].forEach(aluno => {
...
const resultado = melhorAluno(Escola);
console.log("O melhor aluno do ano é: " + resultado.nome + " com uma média de: " + resultado.media);